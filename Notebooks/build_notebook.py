...
def build_ipynb(output_path="Notebooks/student_performance_analysis.ipynb"):
    print("=== Phase 12: Generating Jupyter Notebook ipynb file ===")
    ...
    # Cell 3: Data Collection & Auditing (Markdown)
    cells.append({
        "cell_type": "markdown",
        "metadata": {},
        "source": [
    ...
    # Cell 6: Data Cleaning Code (Code)
    cells.append({
        "cell_type": "code",
        "execution_count": None,
        "metadata": {},
    ...
    # Cell 7: Exploratory Data Analysis (Markdown)
    cells.append({
        "cell_type": "markdown",
        "metadata": {},
        "source": [
    ...
    # Cell 9: Statistical Analysis (Markdown)
    cells.append({
        "cell_type": "markdown",
        "metadata": {},
        "source": [
    ...
    # Cell 10: Statistical analysis code (Code)
    cells.append({
        "cell_type": "code",
        "execution_count": None,
        "metadata": {},
    ...
    # Cell 11: Feature Engineering (Markdown)
    cells.append({
        "cell_type": "markdown",
        "metadata": {},
        "source": [
    ...
    # Cell 13: Machine Learning Model (Markdown)
    cells.append({
        "cell_type": "markdown",
        "metadata": {},
        "source": [
    ...
    # Cell 15: Student Risk Prediction (Markdown)
    cells.append({
        "cell_type": "markdown",
        "metadata": {},
        "source": [
    ...
    # Cell 16: Risk prediction code (Code)
    cells.append({
        "cell_type": "code",
        "execution_count": None,
        "metadata": {},
    ...
    # Cell 17: Case Study BM EXCEL BLAZE (Markdown)
    cells.append({
        "cell_type": "markdown",
        "metadata": {},
        "source": [
    ...
    print(f"Jupyter Notebook successfully built and saved to '{output_path}'.")
